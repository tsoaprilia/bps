...
<div class="jumbotron text-center bg-dark" style="margin-bottom:0">
        ...
        <ul class="navbar-nav">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="yaadmin.php">Data Penduduk</a>
              <a class="dropdown-item" href="yaadmin1.php">Data pertanian dan peternakan</a>
              <a class="dropdown-item" href="yaadmin2.php">Data Kesuburan Tanah</a>
             </div>
 ...
 <div class="jumbotron">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;perkembangan ternak dan pertanian Kota/kabupaten Malang
      <br>
      <br>
      <br>
      <p class="lead">APAKAH INGIN MENAMBAH DATA ?</p> 
      <hr class="my-4">
      <a class="btn btn-primary btn-lg" href="tanitambah.php" role="button">Ya</a>
      <a class="btn btn-primary btn-lg" href="tanitampil.php" role="button">Tidak</a>
    </div>
 <br>
 <br>
 <br>
