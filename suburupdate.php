...
<div class="jumbotron text-center bg-dark" style="margin-bottom:0">
 ...
 <nav class="navbar navbar-expand-sm bg-dark text-center navbar-dark ">
  <a class="navbar-brand text-center" >UPDATE DATA TINGKAT KESUBURAN TANAH</a>
...
$query = "UPDATE suburr SET daerah='$daerah', kadarair='$kadarair', hasilpanen='$hasilpanen', kadarkekeringan='$kadarkekeringan' WHERE idurut='$idurut'";
