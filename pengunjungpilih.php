...
<div class="jumbotron text-center bg-dark" style="margin-bottom:0">
 ...
 <div class="jumbotron">
      ...
      <br>
      <br>
      <p class="lead">Jika sudah "Daftar" silahkan "Masuk"</p> 
      <hr class="my-4">
      <p>Daftar(untuk pengunjung yang baru datang ke website ini) sedangkan Masuk(untuk pengunjung yang sudah pernah mendaftar di website ini)</p>
      <a class="btn btn-primary btn-lg" href="inn.php" role="button">Daftar</a>
      <a class="btn btn-primary btn-lg" href="masuk.php" role="button">Masuk</a>
    </div>
 <br>
 <br>
 <br>
